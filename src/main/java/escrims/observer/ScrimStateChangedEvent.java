...
public class ScrimStateChangedEvent implements DomainEvent {
    ...
    public TipoEvento getTipo() {
        return switch (nuevoEstado) {
            case "LOBBY_ARMADO"     -> TipoEvento.LOBBY_ARMADO;
            case "CONFIRMADO"       -> TipoEvento.SCRIM_CONFIRMADO;
            case "EN_JUEGO"         -> TipoEvento.SCRIM_EN_JUEGO;
            case "FINALIZADO"       -> TipoEvento.SCRIM_FINALIZADO;
            case "CANCELADO"        -> TipoEvento.SCRIM_CANCELADO;
            default                 -> TipoEvento.SCRIM_CREADO;
        };
    }
